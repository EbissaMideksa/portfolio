    ...
    <section className="contact section">
      ...
      <div className="contact_container container grid">
        <div className="contact_data">
          <h3 className="contact-title">Please, feel free!</h3>
          <p className="contact_description">
            Feel free to get in touch with me. I am always open to 
            discuss new projects, creative ideas or oppurtunities
          ...
          <div className="contact_info">
            <div className="info_item">
              ...
              <div>
                ...
                <h4 className="info_desc"> neweebbiwaan1@gmail.com</h4>
              </div>
            ...
            <div className="info_item">
              ...
              <div>
                <span className="info_title">Call</span>
                <h4 className="info_desc">+251930075246</h4>
              </div>
